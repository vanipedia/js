...
document.write('<script type="text/javascript" src="/js/devanagari_font_detector.js"></' + 'script>');
// text compare for edition comparison
document.write('<script type="text/javascript" src="/js/text_compare.js"></' + 'script>');
